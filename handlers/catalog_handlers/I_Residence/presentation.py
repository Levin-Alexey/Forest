...
# Презентация URL
PRESENTATION_URL = "https://s3.twcstorage.ru/d0419efa-bbfb6254-e439-47a2-b99f-612b4490d542/present/9.pdf"
...
async def send_notification_to_group(bot: Bot, user_id: int, username: str, phone: str):
    ...
    try:
        ...
        message_text = (
            "🆕 <b>Новая заявка на презентацию (Резиденция И)</b>\n\n"
...
async def i_presentation_handler(callback: CallbackQuery, state: FSMContext):
    """
    Обработчик кнопки "Получить презентацию" для резиденции И
