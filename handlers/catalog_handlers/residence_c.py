...
from .C_Residence.keyboards import get_residence_c_keyboard
...
async def residence_c_handler(callback: CallbackQuery):
    ...
    await callback.message.answer(
        ...
        reply_markup=get_residence_c_keyboard()
    )


@router.callback_query(lambda c: c.data == "c_back_to_catalog")
async def c_back_to_catalog_handler(callback: CallbackQuery, state: FSMContext):
    """
...
@router.callback_query(lambda c: c.data == "c_back_to_main_menu")
async def c_back_to_main_menu_handler(callback: CallbackQuery, state: FSMContext):
    """
